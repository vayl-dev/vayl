...
<p align="center">
  <img src="docs/vayl-demo.gif" alt="Vayl reconciling memory demo: after 'we moved off Redux to Zustand', recall returns Zustand (not both), with Redux kept in history as SUPERSEDED." width="820">
</p>
